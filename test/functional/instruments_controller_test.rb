...
class InstrumentsControllerTest < ActionController::TestCase
  ...
  test "should create instrument" do
    assert_difference('Instrument.count') do
      post :create, instrument: { amount: @instrument.amount, buydate: @instrument.buydate, name: @instrument.name, shortname: @instrument.shortname, type: @instrument.type, value: @instrument.value }
    end
  ...
  test "should update instrument" do
    put :update, id: @instrument, instrument: { amount: @instrument.amount, buydate: @instrument.buydate, name: @instrument.name, shortname: @instrument.shortname, type: @instrument.type, value: @instrument.value }
    assert_redirected_to instrument_path(assigns(:instrument))
  end
